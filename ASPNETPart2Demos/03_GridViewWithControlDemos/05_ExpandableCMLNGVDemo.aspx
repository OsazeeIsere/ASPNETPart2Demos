<%@ Page Language="C#" AutoEventWireup="true" CodeFile="05_ExpandableCMLNGVDemo.aspx.cs" Inherits="_03_GridViewWithControlDemos_04_MultiLevelNGVDemo" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" 
                ...
                runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" DataKeyNames="EmployeeID" OnRowDataBound="GridView1_RowDataBound">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Orders">
                        <ItemTemplate>
                             ...
                             <img alt = "" 
                             onclick="ShowHide(this, 'GridView1_pnlOrders_<%# Eval("EmployeeID") %>')" 
                        style="cursor: pointer" id="hi" src="/images/plus.png" />
                            ...
                            <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                 <asp:GridView ID="gvOrders" Width="100%" runat="server" 
                                     ...
                                     OnRowDataBound="gvOrders_RowDataBound" ClientIDRowSuffix="OrderID">
...
<img alt = "" onclick="ShowHide(this, 'GridView1_gvOrders_<%# Eval("EmployeeID") %>_pnlOrderDetails_<%# Eval("OrderID") %>')" 
                        style="cursor: pointer" id="hi" src="/images/plus.png" />


                                        <asp:Panel ID="pnlOrderDetails" runat="server" Style="display: none">
