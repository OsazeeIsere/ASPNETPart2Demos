...
public partial class Employees : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private System.Nullable<bool> _IsCertified;
	
	private EntitySet<Employees> _Employees1;
    ...
    partial void OnIsCertifiedChanging(System.Nullable<bool> value);
    partial void OnIsCertifiedChanged();
    #endregion
	
	public Employees()
	{
		this._Employees1 = new EntitySet<Employees>(new Action<Employees>(this.attach_Employees1), new Action<Employees>(this.detach_Employees1));
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsCertified", DbType="Bit")]
	public System.Nullable<bool> IsCertified
	{
		...
		set
		{
			if ((this._IsCertified != value))
			{
				this.OnIsCertifiedChanging(value);
				this.SendPropertyChanging();
				this._IsCertified = value;
				this.SendPropertyChanged("IsCertified");
				this.OnIsCertifiedChanged();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_Employee", Storage="_Employees1", ThisKey="EmployeeID", OtherKey="ReportsTo")]
	public EntitySet<Employees> Employees1
	{
		get
		{
	...
	private void attach_Employees1(Employees entity)
	{
		this.SendPropertyChanging();
		entity.Employee1 = this;
	}
	
	private void detach_Employees1(Employees entity)
	{
		this.SendPropertyChanging();
