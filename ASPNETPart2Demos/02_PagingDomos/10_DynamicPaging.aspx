<%@ Page Language="C#" AutoEventWireup="true" CodeFile="10_DynamicPaging.aspx.cs" Inherits="_08_CRUDWithGridViewUsingBoundFieldDemo" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="Page Number"></asp:Label>
                    </td>
                    <td>
