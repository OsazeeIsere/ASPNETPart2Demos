<%@ Page Language="C#" AutoEventWireup="true" CodeFile="06_CRUDWithListViewWithPagingUsingDataPager.aspx.cs" Inherits="_06" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ListView ID="ListView1" runat="server" 
                ...
                DataKeyNames="EmployeeId" OnItemEditing="ListView1_ItemEditing" OnItemInserting="ListView1_ItemInserting" OnItemUpdating="ListView1_ItemUpdating" InsertItemPosition="LastItem" OnItemCanceling="ListView1_ItemCanceling" OnItemDeleting="ListView1_ItemDeleting" OnPagePropertiesChanging="ListView1_PagePropertiesChanging" OnSelectedIndexChanged="ListView1_SelectedIndexChanged">
